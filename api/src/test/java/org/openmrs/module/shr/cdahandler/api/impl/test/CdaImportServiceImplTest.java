...
public class CdaImportServiceImplTest extends BaseModuleContextSensitiveTest  {
	...
	public void beforeEachTest() throws Exception {
		...
		GlobalProperty disableValidation = new GlobalProperty("validation.disable", "true");
	...
	@Test
	public void shouldParseValidODD() {
		String id = this.doParseCda("/OddCdaDocument.xml");
		assertTrue(id != null);
